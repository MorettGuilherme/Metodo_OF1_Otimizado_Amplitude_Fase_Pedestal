...
titulo_programa = colored("Geração de arquivos de saída pela técnica de validação cruzada K-Fold para a análise do processo de estimação da fase pelo método Optimal Filtering (OF2 Otimizado):\n", attrs=["bold"])
...
def K_fold_OF2_otimizado_analise_fase(parametro, n_ocupacao, n_janelamento_ideal_amplitude_estimada, Matriz_Pulsos_Sinais_Janelado, vetor_fase_referencia_janelado, valor_minimo_amplitude_estimada_processo_fase, tipo_fase, vetor_amplitude_referencia_janelado):
    ...
    for indice_teste in range(0, len(blocos_pulsos_sinais)):
        ...
        bloco_lista_erro_estimacao_fase = metodo_OF2_otimizado(parametro, n_janelamento_ideal_amplitude_estimada, bloco_treino_pulsos_sinais, bloco_teste_pulsos_sinais, bloco_teste_fase_referencia, valor_minimo_amplitude_estimada_processo_fase, bloco_treino_amplitude_referencia)
    ...
    arquivo_saida_dados_estatisticos_erro_estimacao_fase_OF2_otimizado(n_ocupacao, n_janelamento_ideal_amplitude_estimada, media_media_blocos_erro_estimacao_fase, var_media_blocos_erro_estimacao_fase, DP_media_blocos_erro_estimacao_fase, media_tamanho_blocos_erro_estimacao_fase, valor_minimo_amplitude_estimada_processo_fase, tipo_fase, dado_estatistico = "media")
    ...
    arquivo_saida_dados_estatisticos_erro_estimacao_fase_OF2_otimizado(n_ocupacao, n_janelamento_ideal_amplitude_estimada, media_var_blocos_erro_estimacao_fase, var_var_blocos_erro_estimacao_fase, DP_var_blocos_erro_estimacao_fase, media_tamanho_blocos_erro_estimacao_fase, valor_minimo_amplitude_estimada_processo_fase, tipo_fase, dado_estatistico = "var")
