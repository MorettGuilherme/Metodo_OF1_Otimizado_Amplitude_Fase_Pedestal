...
def principal_histograma_erro_estimacao_parametro_OF2_otimizado():
    ...
    if tipo_histograma == "A":
        ...
        lista_erro_estimacao_parametro = metodo_OF2_otimizado(parametro, n_janelamento, Matriz_Pulsos_Sinais_Treino_Janelado, Matriz_Pulsos_Sinais_Teste_Janelado, vetor_parametro_referencia_teste_janelado, valor_minimo_amplitude_estimada_processo_fase, vetor_amplitude_referencia_treino_janelado)
    ...
    # Caso a variável tipo_histograma seja "B".
        ...
        lista_erro_estimacao_parametro_J7 = metodo_OF2_otimizado(parametro, n_janelamento_J7, Matriz_Pulsos_Sinais_Treino_Janelado_J7, Matriz_Pulsos_Sinais_Teste_Janelado_J7, vetor_parametro_referencia_teste_janelado_J7,  valor_minimo_amplitude_estimada_processo_fase, vetor_amplitude_referencia_treino_janelado_J7)
