...
def metodo_OF2_otimizado(parametro, n_janelamento, Matriz_Pulsos_Sinais_Treino_Janelado, Matriz_Pulsos_Sinais_Teste_Janelado, vetor_parametro_referencia_teste_janelado, valor_minimo_amplitude_processo_fase, vetor_amplitude_referencia_treino_janelado):
    ...
    for indice_linha in range(len(Matriz_Pulsos_Sinais_Teste_Janelado)):
        ...
        if parametro == "amplitude":
            ...
            # Cálculo da amplitude estimada pelo método OF2 otimizado.
            valor_parametro_estimado = np.dot(vetor_pesos_amplitude_OF2_otimizado, vetor_pulsos_sinais_teste)
        ...
        # Caso a variável parametro seja igual a "pedestal".
            ...
            valor_parametro_estimado = np.dot(vetor_pesos_pedestal_OF2_otimizado, vetor_pulsos_sinais_teste)
