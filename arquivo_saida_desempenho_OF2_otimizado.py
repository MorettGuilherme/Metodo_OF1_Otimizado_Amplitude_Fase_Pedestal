...
def K_fold_desempenho_OF2_otimizado(parametro, n_ocupacao, n_janelamento_ideal, opcao_avaliacao_desempenho, Matriz_Pulsos_Sinais_Janelado, vetor_parametro_referencia_janelado, valor_minimo_amplitude_processo_fase,  vetor_amplitude_referencia_janelado):
    ...
    for indice_teste in range(0, len(blocos_pulsos_sinais)):
        ...
        bloco_lista_erro_parametro = metodo_OF2_otimizado(parametro, n_janelamento_ideal, bloco_treino_pulsos_sinais, bloco_teste_pulsos_sinais, bloco_teste_parametro_referencia, valor_minimo_amplitude_processo_fase, bloco_treino_amplitude_referencia)
...
def principal_desempenho_OF2_otimizado():
    ...
    for n_ocupacao in tqdm(range(ocupacao_inicial, ocupacao_final+1, incremento_ocupacao)):
        ...
        K_fold_desempenho_OF2_otimizado(parametro, n_ocupacao, n_janelamento_ideal, opcao_avaliacao_desempenho, Matriz_Pulsos_Sinais_Janelado, vetor_parametro_referencia_janelado, valor_minimo_amplitude_processo_fase, vetor_amplitude_referencia_janelado)
