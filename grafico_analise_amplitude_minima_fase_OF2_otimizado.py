...
1) Função para a leitura dos dados estatísticos da análise erro de estimação da fase para uma dada ocupação pelo método OF2 otimizado.
...
def grafico_dado_estatistico_analise_fase_OF2_otimizado(n_ocupacao, opcao_dado_estatistico, Matriz_Dados_Estatisticos_Analise_Fase_Ocupacao):
    ...
    plt.text(0.95, 0.95, texto, horizontalalignment = 'right',
...
def principal_grafico_dado_estatistico_analise_fase_OF2_otimizado():
    ...
    Matriz_Dados_Estatisticos_Analise_Fase_Ocupacao = leitura_dados_estatisticos_analise_fase_OF2_otimizado(n_ocupacao, n_janelamento_ideal_amplitude_estimada, dado_estatistico, tipo_fase)
    grafico_dado_estatistico_analise_fase_OF2_otimizado(n_ocupacao, opcao_dado_estatistico, Matriz_Dados_Estatisticos_Analise_Fase_Ocupacao)
