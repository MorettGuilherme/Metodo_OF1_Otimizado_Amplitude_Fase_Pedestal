...
# Objetivo do código: construção do gráfico da validação cruzada K-Fold para o método OF1 otimizado para a estimação da amplitude, fase ou pedestal.
...
titulo_programa = colored("Plote do gráfico da validação cruzada K-Fold para o método Optimal Filtering (OF1 Otimizado) para a estimação da amplitude, fase ou pedestal:\n", attrs=["bold"])

# Impressão do título do programa.
print(titulo_programa)

### ------------ 1) FUNÇÃO PARA A LEITURA DOS DADOS ESTATÍSTICOS DA VALIDAÇÃO CRUZADA K-FOLD PELO MÉTODO OF1 OTIMIZADO -------------- ###

# Definição da função para a leitura dos dados estatísticos do K-Fold pelo método OF1 otimizado.
def leitura_dados_estatisticos_k_fold_OF1_otimizado(parametro, n_ocupacao, dado_estatistico):
    
    # Nome da pasta em que se encontra o arquivo de entrada dos dados estatísticos do K-Fold.
    pasta_dados_k_fold = f"K_Fold_{parametro}_{dado_estatistico}_Dados_Estatisticos_OF1_Otimizado_OC"

    # Nome do arquivo de entrada dos dados estatísticos do K-Fold.
    arquivo_dados_k_fold = f"k_fold_{parametro}_{dado_estatistico}_dados_estatisticos_OF1_otimizado_OC_{n_ocupacao}.txt"
...
### ----------- 2) INSTRUÇÃO PARA A CONSTRUÇÃO DO GRÁFICO DO TIPO A DA VALIDAÇÃO CRUZADA K-FOLD PELO MÉTODO OF1 OTIMIZADO ----------- ###

# Definição da instrução para a construção do gráfico tipo A pela validação cruzada K-Fold para o método OF1 otimizado.
def grafico_A_k_fold_OF1_otimizado(parametro, opcao, Matriz_Dados_K_Fold_OC_0, Matriz_Dados_K_Fold_OC_10, Matriz_Dados_K_Fold_OC_20, Matriz_Dados_K_Fold_OC_30, Matriz_Dados_K_Fold_OC_40, Matriz_Dados_K_Fold_OC_50, Matriz_Dados_K_Fold_OC_60, Matriz_Dados_K_Fold_OC_70, Matriz_Dados_K_Fold_OC_80, Matriz_Dados_K_Fold_OC_90, Matriz_Dados_K_Fold_OC_100):
...
### ------------ 2) INSTRUÇÃO PARA A CONSTRUÇÃO DO GRÁFICO DO TIPO B DA VALIDAÇÃO CRUZADA K-FOLD PELO MÉTODO OF1 OTIMIZADO ---------- ###

# Definição da instrução para a construção do gráfico do tipo B pela validação cruzada K-Fold para o método OF1 otimizado.
def grafico_B_k_fold_OF1_otimizado(parametro, opcao, Matriz_Dados_K_Fold_OC_0, Matriz_Dados_K_Fold_OC_10, Matriz_Dados_K_Fold_OC_20, Matriz_Dados_K_Fold_OC_30, Matriz_Dados_K_Fold_OC_40, Matriz_Dados_K_Fold_OC_50, Matriz_Dados_K_Fold_OC_60, Matriz_Dados_K_Fold_OC_70, Matriz_Dados_K_Fold_OC_80, Matriz_Dados_K_Fold_OC_90, Matriz_Dados_K_Fold_OC_100):
...
def principal_grafico_k_fold_OF1_otimizado():
    ...
    Matriz_Dados_K_Fold_OC_0 = leitura_dados_estatisticos_k_fold_OF1_otimizado(parametro, 0, dado_estatistico)
    Matriz_Dados_K_Fold_OC_10 = leitura_dados_estatisticos_k_fold_OF1_otimizado(parametro, 10, dado_estatistico)
    Matriz_Dados_K_Fold_OC_20 = leitura_dados_estatisticos_k_fold_OF1_otimizado(parametro, 20, dado_estatistico)
    Matriz_Dados_K_Fold_OC_30 = leitura_dados_estatisticos_k_fold_OF1_otimizado(parametro, 30, dado_estatistico)
    Matriz_Dados_K_Fold_OC_40 = leitura_dados_estatisticos_k_fold_OF1_otimizado(parametro, 40, dado_estatistico)
    Matriz_Dados_K_Fold_OC_50 = leitura_dados_estatisticos_k_fold_OF1_otimizado(parametro, 50, dado_estatistico)
    Matriz_Dados_K_Fold_OC_60 = leitura_dados_estatisticos_k_fold_OF1_otimizado(parametro, 60, dado_estatistico)
    Matriz_Dados_K_Fold_OC_70 = leitura_dados_estatisticos_k_fold_OF1_otimizado(parametro, 70, dado_estatistico)
    Matriz_Dados_K_Fold_OC_80 = leitura_dados_estatisticos_k_fold_OF1_otimizado(parametro, 80, dado_estatistico)
    Matriz_Dados_K_Fold_OC_90 = leitura_dados_estatisticos_k_fold_OF1_otimizado(parametro, 90, dado_estatistico)
    Matriz_Dados_K_Fold_OC_100 = leitura_dados_estatisticos_k_fold_OF1_otimizado(parametro, 100, dado_estatistico)
    
    # Caso a variável tipo_grafico seja "A".
    if tipo_grafico == "A":
        
        # Chamada da função grafico_A_k_fold_OF1_otimizado.
        grafico_A_k_fold_OF1_otimizado(parametro, opcao_dado_estatistico, Matriz_Dados_K_Fold_OC_0, Matriz_Dados_K_Fold_OC_10, Matriz_Dados_K_Fold_OC_20, Matriz_Dados_K_Fold_OC_30, Matriz_Dados_K_Fold_OC_40, Matriz_Dados_K_Fold_OC_50, Matriz_Dados_K_Fold_OC_60, Matriz_Dados_K_Fold_OC_70, Matriz_Dados_K_Fold_OC_80, Matriz_Dados_K_Fold_OC_90, Matriz_Dados_K_Fold_OC_100)
      
    # Caso a variável tipo_grafico seja "B".  
    elif tipo_grafico == "B":
    
        # Chamada da função grafico_B_k_fold_OF1_otimizado.
        grafico_B_k_fold_OF1_otimizado(parametro, opcao_dado_estatistico, Matriz_Dados_K_Fold_OC_0, Matriz_Dados_K_Fold_OC_10, Matriz_Dados_K_Fold_OC_20, Matriz_Dados_K_Fold_OC_30, Matriz_Dados_K_Fold_OC_40, Matriz_Dados_K_Fold_OC_50, Matriz_Dados_K_Fold_OC_60, Matriz_Dados_K_Fold_OC_70, Matriz_Dados_K_Fold_OC_80, Matriz_Dados_K_Fold_OC_90, Matriz_Dados_K_Fold_OC_100)
    
### --------------------------------------------------------------------------------------------------------------------------------- ###

# Chamada da instrução principal do código.
principal_grafico_k_fold_OF1_otimizado()
