...
titulo_programa = colored("Plote do gráfico do dado estatístico do erro de estimação da amplitude, fase ou pedestal ao longo das ocupações para um determinado janelamento pelo método Optimal Filtering (OF2 Otimizado):\n", attrs=["bold"])
...
def leitura_dados_estatisticos_janelamento_OF2_otimizado(parametro, n_janelamento):
    ...
    arquivo_dados_estatisticos_janelamento = f"dados_estatisticos_OF2_otimizado_{parametro}_janelamento_{n_janelamento}.txt"
